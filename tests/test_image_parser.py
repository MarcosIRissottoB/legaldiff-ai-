...
class TestValidateInput:
    ...
    def test_valid_jpeg(self, contract_image_bytes: bytes) -> None:
        ...
        # Solo valida que no lance ValueError por extensión
        # La llamada a OpenAI se mockea abajo
        with patch("src.image_parser._call_vision_api") as mock_api:
...
class TestParseContractImage:
    ...
    def test_api_error_raises_runtime(
        self, mock_api: MagicMock, mock_client: MagicMock
    ) -> None:
